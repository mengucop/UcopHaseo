<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center text-[2rem] leading-[3rem] tracking-tight font-bold text-black dark:text-white">
                    <a href="{{ route('home') }}">
                        {{-- <img class="w-10 h-10" src="{{ asset('storage/logo.png') }}"/> --}}
                        <a href="{{ route('home') }}">Library<span class="text-sky-500"> Management</span> System (Admin)</a>
                    </a>
                </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        @include('layouts.partials.responsive-nav-menu')
