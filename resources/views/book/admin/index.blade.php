                        ...
                        <table class="mx-auto">
                            ...
                            <tbody>
                                ...
                                <tr class="dark:bg-gray-800 border-b hover:bg-gray-300 dark:hover:bg-gray-600 dark:text-white capitalize">
                                        ...
                                        <td class="py-4 px-6 text-center">
                                            {{ $book->copies - $book->borrowBooks->count()  }}
                                        </td>
                                        <td class="py-4 px-6 text-center">
                                        ...
                                        <td class="py-2 px-6">
                                            <x-dropdown align="right" width="48">
                                                ...
                                                <x-slot name="content">
                                                    <x-dropdown-link :href="route('book.show', $book)">
                                                        {{ __('View') }}
                                                    </x-dropdown-link>
                                                    <x-dropdown-link :href="route('book.edit', $book)">
                                                        {{ __('Edit') }}
                                                    </x-dropdown-link>
                                                    <x-dropdown-link :href="route('borrowed.store', $book)"
                                            ...
                                            @include('book.partials.book-borrow-modal')
