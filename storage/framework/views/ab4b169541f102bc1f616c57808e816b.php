...
<?php endif; ?>
    ...
    <?php if(session('expired')): ?>
     <p class="font-medium text-sm text-red-600 dark:text-red-400"><?php echo session('expired'); ?></p>
    <?php endif; ?>
...
<?php endif; ?>
<?php /**PATH D:\Flutt\laragon\www\laravel-library-management-system\resources\views/auth/login.blade.php ENDPATH**/ ?>