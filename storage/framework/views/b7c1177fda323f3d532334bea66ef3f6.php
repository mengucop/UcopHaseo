...
<?php $component->withAttributes([]); ?>
    <?php $__env->startSection('title', 'Borrowed Books'); ?>
     <?php $__env->slot('header', null, []); ?> 
        <?php echo $__env->make('user.partials.borrowed-header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
     <?php $__env->endSlot(); ?>
                                ...
                                <tr class="dark:bg-gray-800 border-b hover:bg-gray-300 dark:hover:bg-gray-600 dark:text-white">
                                    <td class="py-4 px-6 text-center">
                                        <a href="<?php echo e(route('user.showBook', $borrowBook->book->id)); ?>">
                                            <?php echo e($borrowBook->book->title); ?></a>
                                    </td>
                                    <td class="py-4 px-6">
                                    ...
                                    <?php if($borrowBook->status == 'pending'): ?>
                                    <form method="POST" action="<?php echo e(route('request.update', $borrowBook)); ?>">
                                        <?php echo csrf_field(); ?>
...
<?php endif; ?>
                                    ...
                                    <?php elseif($borrowBook->status == 'cancelled' || $borrowBook->status == 'denied'): ?>
                                    <form method="POST" action="<?php echo e(route('request.destroy', $borrowBook)); ?>">
                                        <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH D:\Flutt\laragon\www\laravel-library-management-system\resources\views/user/user-borrowed.blade.php ENDPATH**/ ?>