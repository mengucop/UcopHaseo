            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center text-[2rem] leading-[3rem] tracking-tight font-bold text-black dark:text-white">
                    <a href="<?php echo e(route('home')); ?>">
                        ...
                        <a href="<?php echo e(route('home')); ?>">Library<span class="text-sky-500"> Management</span> System (Admin)</a>
                    </a>
                </div>

                <!-- Navigation Links -->
                    <div class="flex flex-wrap">
                    <?php echo $__env->make('layouts.partials.navigation-links', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
            </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.dropdown-link','data' => ['href' => route('admin.messages')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('admin.messages'))]); ?>
...
<?php endif; ?>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <?php echo $__env->make('layouts.partials.responsive-nav-menu', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

        <!-- Responsive Settings Options -->
        <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">

            <div class="px-4">
                <div class="font-medium text-base text-gray-800 dark:text-gray-200"><?php echo e(Auth::user()->first_name); ?></div>
...
<?php /**PATH D:\Flutt\laragon\www\laravel-library-management-system\resources\views/layouts/navigation.blade.php ENDPATH**/ ?>