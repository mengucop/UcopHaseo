        ...
        <div class="max-w-10xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="flow-root">
                        <a href="<?php echo e(route('category.create')); ?>" class="float-right  bg-blue-700 hover:bg-blue-800 text-white px-4 py-2 mb-4 rounded">Add new category</a>
                    </div>
                            ...
                            <table class="mx-auto">
                                ...
                                <tbody>
                                    ...
                                    <tr class="dark:bg-gray-800 border-b hover:bg-gray-300 dark:hover:bg-gray-600 dark:text-white text-center capitalize">
                                            ...
                                            <td class="py-4 px-6">
                                                <?php echo e($category->updated_at->format('m/d/Y')); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.dropdown-link','data' => ['href' => route('category.edit', $category)]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('category.edit', $category))]); ?>
                                                            <?php echo e(__('Edit')); ?>
...
<?php endif; ?>
                                                        <form method="POST" action="<?php echo e(route('category.destroy', $category)); ?>">
                                                            <?php echo csrf_field(); ?>
                                                            <?php echo method_field('delete'); ?>
                                                            <?php if (isset($component)) { $__componentOriginal68cb1971a2b92c9735f83359058f7108 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal68cb1971a2b92c9735f83359058f7108 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.dropdown-link','data' => ['href' => route('category.destroy', $category),'onclick' => 'event.preventDefault();
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('category.destroy', $category)),'onclick' => 'event.preventDefault();
...
<?php endif; ?>
<?php /**PATH D:\Flutt\laragon\www\laravel-library-management-system\resources\views/book/admin/categories.blade.php ENDPATH**/ ?>